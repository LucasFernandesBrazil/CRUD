  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="adicionar_produto.php" class="btn btn-primary"><i class="fas fa-plus-circle"></i>&nbsp&nbspCadastrar produto</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="listar_produtos.php" class="btn btn-primary"><i class="fas fa-list-ul"></i>&nbsp&nbspProdutos</a>
      </div>
    </div>
  </div>
</div>
